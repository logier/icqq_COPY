...
* export axios for reuse in other projects ([f7c9f37](https://github.com/logier/icqq_COPY/commit/f7c9f37c34f6403870b7a1aaeaf53610b64b6a60))
* tlv548 ([498a611](https://github.com/logier/icqq_COPY/commit/498a611d00c886875a5e78206b0e4700baf558f1))
* 实现消息签名组包（test）。 ([e75fa03](https://github.com/logier/icqq_COPY/commit/e75fa0334ab01bb56c9824058831931f63e90f94))
* 新增安卓QQ8.8.88版本协议，Platform = 6，无法登录的可尝试。 ([e3baaa6](https://github.com/logier/icqq_COPY/commit/e3baaa621d0b2f458e6d113e5df7d3872f0ad467))
* 解析新 QQNT 发送的图片 ([f0e973b](https://github.com/logier/icqq_COPY/commit/f0e973b522904463a83c723d1c6a2e6d4ecea0f4))


### Bug Fixes

* ？ ([586d80b](https://github.com/logier/icqq_COPY/commit/586d80be24922d50721afc373fc4fc1305bfa611))
* . ([d99c3b0](https://github.com/logier/icqq_COPY/commit/d99c3b05a93da16e4b13b229f0646b48766ea21c))
* 。 ([bed55e2](https://github.com/logier/icqq_COPY/commit/bed55e2c1fbd631e50e8b3936bf146d0e2445a5d))
* 。 ([4700e26](https://github.com/logier/icqq_COPY/commit/4700e263d10e14b36097fe11b3db8b3ad3656597))
* 。 ([0d78051](https://github.com/logier/icqq_COPY/commit/0d78051bdbd326bfca3216fe84f43b3ad312656d))
* 。 ([64682e8](https://github.com/logier/icqq_COPY/commit/64682e839c6908cb0c361bd557b9d61e5fdb5706))
* 544改为本地计算 ([df2a208](https://github.com/logier/icqq_COPY/commit/df2a20845f4119dc437afc5133e0ea75b95dd522))
* add some demo of icqq ([b8f6e12](https://github.com/logier/icqq_COPY/commit/b8f6e12e83071776cd5cf1309927a93fd2a06c93))
* add tlv16a ([6573e3a](https://github.com/logier/icqq_COPY/commit/6573e3a487571e5bf373511010735bbedd1b0ba9))
* apk增加device_type参数（用于扫码登录）。 ([b245101](https://github.com/logier/icqq_COPY/commit/b2451019f41e611fded48ac8b15dc1d3fe18cc9c))
* Config增加签名接口地址配置，可自行实现签名API，供ICQQ调用 ([412c387](https://github.com/logier/icqq_COPY/commit/412c3871ed84bd03d53d8f61127e4bbb29c431fd))
* deviceInfo ([a075c86](https://github.com/logier/icqq_COPY/commit/a075c865b04f9f09fb63d2eb5c3fc6df1ed553fe))
* device降会35 ([667bac7](https://github.com/logier/icqq_COPY/commit/667bac7c6a93d5dec8d576ff61b708beb2de32a2))
* highwayUpload ([64d34c6](https://github.com/logier/icqq_COPY/commit/64d34c64a13085a83ba12976489c631a406e25a9))
* internal中，获取个性签名方法getSign弃用，后续开发中请使用更具语义化的getPersonalSign替换;client增加获取个性签名方法(getSignature) ([39be3f5](https://github.com/logier/icqq_COPY/commit/39be3f5ad3129478f5a56b1bad5582a69bac6c4d))
* iPad -&gt; aPad ([98d5110](https://github.com/logier/icqq_COPY/commit/98d51109480ecd4e770eec006052a8dd7b2909f2))
* ipad ver ([58e2529](https://github.com/logier/icqq_COPY/commit/58e2529642a011ce8f29dd5d1a6b95590d479c8b))
* ipad协议登录报错问题（不是解决禁止登录）。 ([1c718ad](https://github.com/logier/icqq_COPY/commit/1c718ad43bb31dadac899af076c7a74744312c03))
* login error 16 ([f4d9c4f](https://github.com/logier/icqq_COPY/commit/f4d9c4fc82462ca2238b36fb7dcf1f0c7e18b687))
* mac协议无法登录问题。 ([c06e734](https://github.com/logier/icqq_COPY/commit/c06e734079881b5ac27425ec48cdd863f323ee69))
* out dir error ([fc69814](https://github.com/logier/icqq_COPY/commit/fc69814108d6f2798d514847a8de8aebc9058a5b))
* packet timeout ([f063def](https://github.com/logier/icqq_COPY/commit/f063def8c8851417a48d27ca09f81bf6c2d659b1))
* parseSso ([89ed4de](https://github.com/logier/icqq_COPY/commit/89ed4de77ea82719f4fa744bca17f7d2579cd762))
* PoW 算法错误 ([5f47445](https://github.com/logier/icqq_COPY/commit/5f4744596b78b88c12189f5b9ac89b2f294be299))
* prettier log ([984d59b](https://github.com/logier/icqq_COPY/commit/984d59be7b62333f73a3446a4b2349c30170d660))
* pretty code;allow custom logger ([0e57711](https://github.com/logier/icqq_COPY/commit/0e5771128f886b227acf911746a75f73845b535c))
* Proto类增加toJSON()方法，方便调试 ([3094c6e](https://github.com/logier/icqq_COPY/commit/3094c6e49f7047d2fdef7e9759414542ed077199))
* publish error ([ec80b45](https://github.com/logier/icqq_COPY/commit/ec80b454bc0a236fd0348945b862ca0e66fd750b))
* qimei ([498a611](https://github.com/logier/icqq_COPY/commit/498a611d00c886875a5e78206b0e4700baf558f1))
* qimei in T545 ([eba6355](https://github.com/logier/icqq_COPY/commit/eba63557f6ad5d974f7a034ce3ac6ccf794dd7ff))
* QQNT图片解析、优化转发消息上传。 ([65b7bc0](https://github.com/logier/icqq_COPY/commit/65b7bc07f581da2f0c169917aa853c70cdae11f2))
* qsignApi异常时不输出错误问题。 ([e3411f8](https://github.com/logier/icqq_COPY/commit/e3411f8f7b547fb1d93ff4d57bca9dead655dd58))
* refreshToken ([c19b26f](https://github.com/logier/icqq_COPY/commit/c19b26f4ffaad465266c85f3b3a1f7f6043a2ed5))
* replaceAll语法调整 ([3ada7dd](https://github.com/logier/icqq_COPY/commit/3ada7ddec5f5845dbc315d505e93f9086807a15d))
* reply 重复处理 ([32c2489](https://github.com/logier/icqq_COPY/commit/32c24897126f6a4ec9b3d4a82fe9e37cbd1f31de))
* requestToken ([a6dca70](https://github.com/logier/icqq_COPY/commit/a6dca707bfa15470f889d81670e49940440530e9))
* ReserveFields ([007db25](https://github.com/logier/icqq_COPY/commit/007db258e336f88739fac1f5648051aa4a11ca29))
* run lint:fix ([226926b](https://github.com/logier/icqq_COPY/commit/226926b0b305be76212726e628f73579f12f84ee))
* seq ([7f24e8f](https://github.com/logier/icqq_COPY/commit/7f24e8f9b8e8e4e71926c8a4c6fbec7c90d54d57))
* SidTicketExpired？ ([daa5c11](https://github.com/logier/icqq_COPY/commit/daa5c116968a38d45f3438f07fdb6f0f70be79fe))
* signApi请求超时时间改为15秒、qsignApi请求超时时间改为30秒。 ([13e88fd](https://github.com/logier/icqq_COPY/commit/13e88fd7008b82dc88d483d68d59b13b97c23109))
* sign请求增加重试。 ([12d8962](https://github.com/logier/icqq_COPY/commit/12d896275fe40caabada3d0caeb2234faa4b5764))
* sign重试增加延迟。 ([2ce30e6](https://github.com/logier/icqq_COPY/commit/2ce30e65451d8f1f24972b993a206348f615e2c7))
* t543读取失败时增加警告 ([3374857](https://github.com/logier/icqq_COPY/commit/33748579a15e2209ed591be75529354f20c2032b))
* t548 算法错误 ([790f5ff](https://github.com/logier/icqq_COPY/commit/790f5ff07c56f1a2773ab9461ac2f456e61cc4df))
* tgtgt错误，兼容原版oicq登录方式 ([0bab3e0](https://github.com/logier/icqq_COPY/commit/0bab3e09d63cc85a6c27de0dfd87f1a3aa5feacf))
* Tim协议心跳超时问题 ([a7d950e](https://github.com/logier/icqq_COPY/commit/a7d950e8148949add76f933065de0433b8421f7c))
* tlv543读取失败不用提示。 ([bf0f555](https://github.com/logier/icqq_COPY/commit/bf0f555e9b37e35761eaf99796c377980c4c92f8))
* tlv545 ([715df56](https://github.com/logier/icqq_COPY/commit/715df56aadabedbcff4a24527c105a6870f9c311))
* token 登录失败 ([2d769ee](https://github.com/logier/icqq_COPY/commit/2d769ee9c9471827a93cf4ff83429a82c2f939fe))
* token可能失效时不删除token文件。 ([035ee3a](https://github.com/logier/icqq_COPY/commit/035ee3a76050f2386d34c3dbc732765accd7e8f1))
* token失效后报错问题。 ([90e769c](https://github.com/logier/icqq_COPY/commit/90e769ccd527999fff1a595e04c0de2444443036))
* token登录提示 ([d2002f8](https://github.com/logier/icqq_COPY/commit/d2002f88e21d955383549eeba9a07bcf283df82c))
* typo permisson → permission ([dc435b1](https://github.com/logier/icqq_COPY/commit/dc435b1f35b018131e68235d83536c060d7d19a7))
* 上线失败问题。 ([c12ea7a](https://github.com/logier/icqq_COPY/commit/c12ea7a69174ed340b1bb38db2f804f239970fc0))
* 优化token上线。 ([89f53fe](https://github.com/logier/icqq_COPY/commit/89f53fe068eb485ce810abcc06ba39a3d6faec83))
* 优化token上线。 ([41a076c](https://github.com/logier/icqq_COPY/commit/41a076ccbcbd7b39064339b7c4fcaa3453427400))
* 优化上线流程。 ([a1d4adb](https://github.com/logier/icqq_COPY/commit/a1d4adbcd5d312b4c8032b07a37b877e93286306))
* 修复node16以上版本无法正常使用问题。 ([c570689](https://github.com/logier/icqq_COPY/commit/c570689835627c5e2c64fb50ebfaf355aa3147fa))
* 修复seq为负数时报错问题。 ([9c8c4f8](https://github.com/logier/icqq_COPY/commit/9c8c4f8a7f48e5beaf9afcd74eaca0679bd7cad2))
* 修复token刷新失败问题，刷新间隔修改为12小时。 ([bdbfb44](https://github.com/logier/icqq_COPY/commit/bdbfb44e2bb39976ecc28a6d0990dd8b4381ccc6))
* 修复watch 扫码登陆 ([02a5749](https://github.com/logier/icqq_COPY/commit/02a5749477fdd62e39f8275b1fd23ac82695d8c5))
* 修复扫码登录提示密码错误问题。 ([fc7c80e](https://github.com/logier/icqq_COPY/commit/fc7c80ea066b0170515aed1337b13759959bc246))
* 修复无法发送短信验证码问题。 ([8d397bd](https://github.com/logier/icqq_COPY/commit/8d397bd7965e6b9b6c7c5814c03114898d5b515e))
* 修复未指定ver时报错问题，增加安卓8.9.70.11730版本信息，导出tlv543。 ([20605c6](https://github.com/logier/icqq_COPY/commit/20605c69941e7bf19519672f5020f785bb20ddfa))
* 修复版本过低。 ([79540d7](https://github.com/logier/icqq_COPY/commit/79540d75b618fc4ae79ba8a235df4b1df17f56c3))
* 修复特定情况下可能会出现解密返回包失败问题。 ([62f3f12](https://github.com/logier/icqq_COPY/commit/62f3f12fa8318ebe546cc54a8cf76b04c6282ec1))
* 修改token失效重试。 ([185c80b](https://github.com/logier/icqq_COPY/commit/185c80b5fd93da50a7f8dd0ba24b20ff01871597))
* 修改登录失败提示。 ([02f748a](https://github.com/logier/icqq_COPY/commit/02f748a8f7d6191e2788a4f6346eca6397eed6a9))
* 修改签名log、修改私聊消息发送失败判断。 ([ac0f22a](https://github.com/logier/icqq_COPY/commit/ac0f22a3bd7703edbf19b793835308da5e806c7e))
* 修改频道消息发送失败判断。 ([3b148da](https://github.com/logier/icqq_COPY/commit/3b148dad1067c04879a52123aaed5950e481bd27))
* 刷新token时备份上次token，登录时如找不到token将使用上次的token进行登录 ([8b2a872](https://github.com/logier/icqq_COPY/commit/8b2a872a915b6c05b37a6441cf23e2d4879c61eb))
* 刷新token错误 ([15bd8b4](https://github.com/logier/icqq_COPY/commit/15bd8b4c0074d047e0793f08c6a0f07befa92ddd))
* 刷新登录token失败问题。 ([6642e59](https://github.com/logier/icqq_COPY/commit/6642e595f62d96fd38836e4fd870772f94a37869))
* 刷新签名token间隔改为1小时，更新QQ版本信息到8.9.68.11565。 ([32dcfdf](https://github.com/logier/icqq_COPY/commit/32dcfdf117d1160bbdfc65f19c7066ee81650e63))
* 升级triptrap ([eb007a2](https://github.com/logier/icqq_COPY/commit/eb007a292acb1dc7347b1706ceee4f2a90a2ce77))
* 合并转发使用预处理 ([7341edf](https://github.com/logier/icqq_COPY/commit/7341edf6632703441f4869cf86c2063ac245f7d1))
* 增加8.9.73.11945。 ([b03ff02](https://github.com/logier/icqq_COPY/commit/b03ff028207094daaea47c84a69193d646c0a177))
* 增加8.9.75.12110 ([261c992](https://github.com/logier/icqq_COPY/commit/261c992e13dcb6a5fc01d004cf633114c3b3185b))
* 增加8.9.76.12115 ([5157ea7](https://github.com/logier/icqq_COPY/commit/5157ea7c25ec05942b0c7cf26c9be425ce142cc5))
* 增加8.9.85.12820。 ([77a2ec0](https://github.com/logier/icqq_COPY/commit/77a2ec023f21e84c0248fd0c06cd288706701912))
* 增加8.9.88.13035。 ([760c4cd](https://github.com/logier/icqq_COPY/commit/760c4cdcf4b737c0812c6b8a27794d461d87c541))
* 增加8.9.90.13250。 ([cd17c52](https://github.com/logier/icqq_COPY/commit/cd17c5211f46ff34995f52c1c0a8ae17632d50cb))
* 增加8.9.93.13475。 ([0576fd5](https://github.com/logier/icqq_COPY/commit/0576fd527732bdd72178ee0a97040b3c0f999dbe))
* 增加9.0.0.14110。 ([f8105cb](https://github.com/logier/icqq_COPY/commit/f8105cbba66d567062539d24a3a0c89f1e85e454))
* 增加9.0.15.14970。 ([919e3cd](https://github.com/logier/icqq_COPY/commit/919e3cd0a233391aa90317621e515c25c5fde7a1))
* 增加9.0.17.15185 ([caad99b](https://github.com/logier/icqq_COPY/commit/caad99b0f44a8e78b11396b8b76853b330393f8a))
* 增加9.0.8.14755。 ([0f33e42](https://github.com/logier/icqq_COPY/commit/0f33e42ba33ed2cc01592539a71ff15cec5c0fe2))
* 增加Android 8.9.78.12275。 ([1c4bce8](https://github.com/logier/icqq_COPY/commit/1c4bce8eb94b3c8aaf0a6f4e0d6db789e059c8f1))
* 增加register失败时自动重试。 ([671307d](https://github.com/logier/icqq_COPY/commit/671307db65d7c5f343e9710884adc3e52119e825))
* 增加Tim 3.5.6.3208。 ([bd609aa](https://github.com/logier/icqq_COPY/commit/bd609aa5a8097e7e432bf0f1514d7dd1ddc0eb9f))
* 增加Tim3.5.2.3178版本信息。 ([c0934c6](https://github.com/logier/icqq_COPY/commit/c0934c65e56a5d6a4df86c1e735525a00ae06ce4))
* 增加可组合发送的元素 ([c6786cc](https://github.com/logier/icqq_COPY/commit/c6786ccee6134fe5efff9e2fbf6487da941c3617))
* 增加频道相关接口 ([ce7cd33](https://github.com/logier/icqq_COPY/commit/ce7cd3344fe71744621621d426d4212ad2bfa4c4))
* 增加频道相关接口... ([e071ea8](https://github.com/logier/icqq_COPY/commit/e071ea80f728720cd5e2e306d9440ffb59e12248))
* 安卓手表增加2.1.7版本，安卓手机、apad等可扫码登录。 ([2157196](https://github.com/logier/icqq_COPY/commit/2157196997b23339571b0ca4596b1a3658675c17))
* 安卓手表默认版本改为2.0.8。 ([6c33947](https://github.com/logier/icqq_COPY/commit/6c33947322913907831944666e544e9077fdd7e5))
* 对于可能存在多个版本的android和aPad，允许用户指定apk(目前仅支持8.9.63,8.9.68) ([4fe1165](https://github.com/logier/icqq_COPY/commit/4fe1165b04d6a17cd070b59172b3d1c62cdf60a7))
* 对超级表情进行修复，sface消息类型 ([feca7ed](https://github.com/logier/icqq_COPY/commit/feca7eda721b351bc24cb967bc844de1416c8d89))
* 将安卓8.8.88协议替换为Tim3.5.1（platform: 6）需配合签名api使用 ([6ef5b26](https://github.com/logier/icqq_COPY/commit/6ef5b26f33921298f774c54ed0906c8b3ae0f0e4))
* 屏蔽tim扫码登录（不支持）。 ([c28b102](https://github.com/logier/icqq_COPY/commit/c28b102291d1513d449487603991698a77b8f8fb))
* 屏蔽传参错误 ([ecbc72e](https://github.com/logier/icqq_COPY/commit/ecbc72ebc9af5011f7fb9f5191b57a242d1fa1f9))
* 已设置签名api的情况下，签名api请求异常时不发送消息。 ([5150274](https://github.com/logier/icqq_COPY/commit/5150274663c5d2133330920fcda6e36757936dde))
* 当传入不支持组合发送的元素时丢弃其他元素。 ([32509fb](https://github.com/logier/icqq_COPY/commit/32509fb4f4c4b8fc45def6c8876bff4104121909))
* 手表协议刷新token失败。 ([55c2245](https://github.com/logier/icqq_COPY/commit/55c2245e7ae9dacdd52903faf118d23976af233b))
* 扫码登录。 ([c2c38d5](https://github.com/logier/icqq_COPY/commit/c2c38d570c26ebcd05f68305f9ad4d0a00f42652))
* 提交验证码时计算t547。 ([8b21c01](https://github.com/logier/icqq_COPY/commit/8b21c01a7af3c86267fd29b8322531a6fd1e95ca))
* 提示：此版本更新了token格式，刷新后token将不兼容旧版本。 ([dbd6ac6](https://github.com/logier/icqq_COPY/commit/dbd6ac659d66c2371fbcbe83f06bb2e2be32647d))
* 支持Button消息解析。 ([95cc162](https://github.com/logier/icqq_COPY/commit/95cc162a86dc526ff20352096ab6b19893dad5d6))
* 支持markdown消息解析。 ([79d169e](https://github.com/logier/icqq_COPY/commit/79d169e09b2b3ba731c3f5ce496d02fb53d46727))
* 支持silk转码（silk-wasm）、修复掉线重连报错问题。 ([aea0163](https://github.com/logier/icqq_COPY/commit/aea0163e3880b6dfa2ced12e43862584ebff7108))
* 支持群文件转发到私聊以及私聊文件转发到群聊。 ([338c5d2](https://github.com/logier/icqq_COPY/commit/338c5d2a6f500e6a419382e4a4f2e1b56b8344b8))
* 支持自定义图片概要。 ([ee7a634](https://github.com/logier/icqq_COPY/commit/ee7a634f81d42de1f468d7bea845fb696b06aa7c))
* 支持重写client.getSign（可自行实现调用第三方签名api） ([e87a275](https://github.com/logier/icqq_COPY/commit/e87a275c8d0214bdded3ac9401a8be29a3ff5a77))
* 新增设置屏蔽群成员消息屏蔽状态函数(setGroupMemberScreenMsg)，设置为true后，登录账号将在该群不再接受对应群成员消息 ([771311f](https://github.com/logier/icqq_COPY/commit/771311f5397f1d98da907947cedcd22641e25c3b))
* 更改t543缺失警告文案 ([bb2efaf](https://github.com/logier/icqq_COPY/commit/bb2efaf30a8bdf46b551df0fee7141c159d2ba3c))
* 更改watch自动扫码登陆提示 ([68b4743](https://github.com/logier/icqq_COPY/commit/68b474374c1e855db369e00097d6e13c63252285))
* 更新 T544 API ([8ac1c45](https://github.com/logier/icqq_COPY/commit/8ac1c457460678e50695a82c773dc3f3bcd2f6b0))
* 更新8.9.63、默认关闭auto_server ([86a345c](https://github.com/logier/icqq_COPY/commit/86a345ca089e9d38b73d22c6caf25003393b2951))
* 更新GuildMessageEvent.reply方法签名 ([57bf4ec](https://github.com/logier/icqq_COPY/commit/57bf4ec308d2c109557d9b7105dcead81f55ca20))
* 更新QQ版本信息。 ([fc428ac](https://github.com/logier/icqq_COPY/commit/fc428ac301ac31197b98c8979c6f8e190e3b68f4))
* 更新ts文件到src，便于区分编译文件和源文件 ([dbca2bb](https://github.com/logier/icqq_COPY/commit/dbca2bbb8b98b8f2c68294fcf4024dcc1b8a5dd4))
* 未在config中指定版本时，自动使用签名Api支持的协议版本。 ([11f85fe](https://github.com/logier/icqq_COPY/commit/11f85fe70713ffaab52571b3626d48a2a0725bac))
* 未配置sign API改为只提示一次 ([45e6040](https://github.com/logier/icqq_COPY/commit/45e604043a97ee49fac6a055a1f409801780a8b3))
* 未配置sign API改为只提示一次 ([45e6040](https://github.com/logier/icqq_COPY/commit/45e604043a97ee49fac6a055a1f409801780a8b3))
* 沙箱环境以外的访问到client ([8662855](https://github.com/logier/icqq_COPY/commit/8662855e52b7f28ec7c8089bdd53620009da47fd))
* 添加uid参数、tlv543保存到token。 ([a324089](https://github.com/logier/icqq_COPY/commit/a32408968784a197a14361fe4e6460c646ecaa7f))
* 添加一些签名cmd名单。 ([1496192](https://github.com/logier/icqq_COPY/commit/149619283a6fa9652768cfbde96eba5768c69d25))
* 禁止Tim协议设置在线状态 ([baa7612](https://github.com/logier/icqq_COPY/commit/baa76125b1eaf9d475e171138337fad85fd554d5))
* 禁言等功能失效问题。 ([1245c3e](https://github.com/logier/icqq_COPY/commit/1245c3eb6492bb33120e1887b10d17bdc744c012))
* 私聊 QQNT 图片 URL ([d118796](https://github.com/logier/icqq_COPY/commit/d118796af9c294b3bdcf7ee43565c2d53236cc1d))
* 移除lodash依赖 ([b437b51](https://github.com/logier/icqq_COPY/commit/b437b5115295f626e2d2f3cf5f3f7e9c31594ca1))
* 签名api可以不带path。 ([1c1b09e](https://github.com/logier/icqq_COPY/commit/1c1b09e1b8a21dbf8734b35ae2db4f37dafb63d4))
* 签名api请求异常时显示错误信息、qsign请求超时时间改为20秒。 ([c0f26be](https://github.com/logier/icqq_COPY/commit/c0f26be62574f692cffee2e223c116eea1b7e0d3))
* 签名token改为每50分钟刷新一次、修改了设备信息（更新后需要重新验证设备！） ([2d92001](https://github.com/logier/icqq_COPY/commit/2d920013a80a44307855a48173d4ba0ed6271699))
* 类型错误处理 ([b081084](https://github.com/logier/icqq_COPY/commit/b081084500469f324b388668f4c7767f82711160))
* 群文件操作。 ([0078316](https://github.com/logier/icqq_COPY/commit/0078316e7340bb64cd236ed42d1241df49c646b8))
* 群聊图片ios端显示为表情问题。 ([737f02e](https://github.com/logier/icqq_COPY/commit/737f02ef5c157c3dc483e8318712c8b3ff142d68))
* 获取签名Api协议版本时判断sign是否已经初始化。 ([acb6c78](https://github.com/logier/icqq_COPY/commit/acb6c78be6b58db58fbda038408ad4ca698af5ce))
* 语音转码后删除缓存，支持发送 Buffer 视频 ([1000e42](https://github.com/logier/icqq_COPY/commit/1000e4268eea1e71533eba1722a7588d53bd8f71))
* 转发消息改为json。 ([671ca31](https://github.com/logier/icqq_COPY/commit/671ca3155a99244166e15bcf213661334b15e584))
* 适配qsign自动注册。 ([73b1d4c](https://github.com/logier/icqq_COPY/commit/73b1d4c1ad7563153a7cb2ca96170c59a97a12f9))
* 部分环境下出现下载转发消息出错问题。 ([e82a784](https://github.com/logier/icqq_COPY/commit/e82a7845e24b43920281494c83a0be57555e1995))
* 频道身份组成员列表为空时出错问题。 ([28e6da8](https://github.com/logier/icqq_COPY/commit/28e6da8da4b316a60d1c2849dd2a47b34dad4909))
* 默认安卓协议默认版本改为8.9.70。 ([db0e4c5](https://github.com/logier/icqq_COPY/commit/db0e4c55a48985e5db771064a7914835a8462686))
